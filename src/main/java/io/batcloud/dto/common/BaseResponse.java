...
public class BaseResponse<T> implements Serializable{
    ...
    public BaseResponse(Integer code, String msg,T data ,Long startTime){
	...
	public void setCostTime(Long startTime) {
		 this.costTime = System.currentTimeMillis() - startTime;   
	}
     ...
     * @since JDK 1.7
     */
    public static <E> BaseResponse<E> success(E data,Long startTime) {
        BaseResponse<E> result = new BaseResponse<E>(0,"success",data,startTime);
        return result;
    }
